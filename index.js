...
USRIoT.prototype.handleCmdResponse = function (packet, parameter /*Buffer*/) {
    ...
    switch (packet) {
        ...
        case 0x03:
            ...
            this.emit('response', {cmd: 'output.' + parameter[0], value: parseInt(parameter[1]) & 1});
            break;
        case 0x04:
            this.emit('output.all', '00000000');
            this.emit('response', {cmd: 'output.all', value: '00000000'});
            break;
        case 0x05:
            this.emit('output.all', '11111111');
            this.emit('response', {cmd: 'output.all', value: '11111111'});
            break;
        case 0x13:
            break;
        case 0x14:
            ...
            this.emit('response', {cmd: 'output.all', value: status});
            break;
        case 0x06:
        case 0x0a:
            var oldStatus = 0;
        ...
        case 0x70:
            ...
            this.emit('response', {cmd: 'deviceinfo', value: info});
            break;
        case 0x7f:
